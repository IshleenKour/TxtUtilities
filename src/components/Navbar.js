  ...
  <div className="container-fluid">
   // <a className="navbar-brand" href="#">{props.title}</a> 
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nanv me-auto mb-2 mb-lg-0">
      ...
      <div className={`form-check form-switch text-${props.mode==='light'?'dark':'light'}`}> {/*}`` backticks to make it a template string*/}
